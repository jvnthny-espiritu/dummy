...
<body>
    ...
    <section class= "villa" id="villa_id">
	   <h1>Standard Bedroom</h1>
	    <p>Take a look at our Standard Bedroom!</p>
    
	
	   <div class= "row">
		  <div class= "villa-col">
			<img src= "img\standardr.jpg" alt= "standard bed room"><br><br>			
		 </div>

         <div class= "villa-col">
            <p>RATE: PHP 500.00
              1 Double - Sized Bed for 1 to 2 person 

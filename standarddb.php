...
<body>
    ...
    <section class="container mt-5" id="villa_id">
        <h1 class="text-center">Standard Double Bedroom</h1>
        <p class="text-center">Take a look at our Standard Double Bedroom!</p>
        
        <div class="row justify-content-center">
            <div class="col-md-6">
                <img src="img/standarddb.jpg" alt="Standard Double Bedroom" class="img-fluid mb-4">
            </div>
            <div class="col-md-6">
                <div class="border bg-light p-3 rounded mb-3">
                    <p><strong>RATE:</strong> PHP 800.00<br>
                        1 room - 2 Single Size Bed for 1 to 2 persons<br>
                    ...
                    <form action="confirm_booking.php" method="post">
                        ...
                        <input type="hidden" name="service_id" value="5"> <!-- Assuming 5 is the service ID for standard double bedroom -->

...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#header_id">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#villa_id">Villas & Rooms</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#about_id">About Us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php#contact_id">Contact</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="container mt-5" id="villa_id">
        <h1 class="text-center">Premium Villa</h1>
        <p class="text-center">Take a look at our Premium Villa!</p>
        
        <div class="row justify-content-center">
            <div class="col-md-6">
                <img src="img/premiumvilla.jpg" alt="Premium Villa" class="img-fluid mb-4">
            </div>
            <div class="col-md-6">
                <div class="border bg-light p-3 rounded mb-3">
                    <p><strong>RATE:</strong> PHP 2800.00<br>
                        3 Bedroom: 3 Queen Size Beds<br>
                        Room for a maximum of 6 persons<br>
                        70 m² - Balcony - Garden view - Pool with a view - Inner courtyard view - Air conditioning - Ensuite bathroom - Terrace - Free WiFi
                    </p>
                    <form action="confirm_booking.php" method="post">
                        ...
                        <input type="hidden" name="service_id" value="3"> <!-- Assuming 3 is the service ID for premium villa -->

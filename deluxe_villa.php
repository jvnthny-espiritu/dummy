...
<body>
    ...
    <section class="container mt-5" id="villa_id">
        <h1 class="text-center">Deluxe Villa</h1>
        <p class="text-center">Take a look at our Deluxe Villa!</p>
        
        <div class="row justify-content-center">
            <div class="col-md-6">
                <img src="img/deluxevilla.jpg" alt="Deluxe Villa" class="img-fluid mb-4">
            </div>
            <div class="col-md-6">
                <div class="border bg-light p-3 rounded mb-3">
                    <p><strong>RATE:</strong> PHP 1800.00<br>
                        Bedroom: 1 Queen Size Bed<br>
                        Bedroom 2: 1 Double Bed - Room for 3 to 4 persons<br>
                        70 m² - Balcony - Garden view - Pool with a view - Inner courtyard view - Patio - Air conditioning - Ensuite bathroom - Terrace - Free WiFi
                    </p>
                    <form action="confirm_booking.php" method="post">
                        ...
                        <input type="hidden" name="service_id" value="2"> <!-- Assuming 2 is the service ID for deluxe villa -->

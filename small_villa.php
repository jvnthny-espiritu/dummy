...
<body>
    ...
    <section class="container mt-5" id="villa_id">
        <h1 class="text-center">Small Villa</h1>
        <p class="text-center">Take a look at our Small Villa!</p>
        
        <div class="row justify-content-center">
            <div class="col-md-6">
                <img src="img/smallvilla.jpg" alt="Small Villa" class="img-fluid mb-4">
            </div>
            <div class="col-md-6">
                <div class="border bg-light p-3 rounded mb-3">
                    <p><strong>RATE:</strong> PHP 1500.00<br>
                        1 room for 1 to 3 persons<br>
                        40 m² - Balcony - Garden view - Pool with a view - Inner courtyard view - Air conditioning - Ensuite bathroom - Terrace - Free WiFi
                    </p>
